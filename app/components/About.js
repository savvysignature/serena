...
export default function About() {
  return (
    <section id="about" className="py-20 sm:py-24 lg:py-32 bg-linear-to-b from-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
            ...
            >
              ...
              {/* Decorative elements */}
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-indigo-200/30 rounded-full blur-2xl -z-10" />
            </motion.div>
            ...
            >
              <p>
                ...
                With more than <strong className="text-indigo-600">25 years of professional experience</strong>,
